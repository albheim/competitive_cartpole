...
# ╔═╡ 59cfcf12-0459-11ee-232c-ed666241a2cc
using ModelingToolkit, ControlSystems, LinearAlgebra, Plots

# ╔═╡ 6929941a-bdf6-4583-ad8e-0f0acb5391a8
@variables t x(t)=0 theta(t)=0 x_t(t)=0 theta_t(t)=0 u(t)=0

# ╔═╡ 3b8955a8-15c2-4ca3-99e9-0a22a3c1b1bd
@parameters m=2 M=1 g=800 l=150

# ╔═╡ 2d073b91-09c0-43b0-a44b-30f8e205df5e
D = Differential(t)

# ╔═╡ 8280b0f8-c246-4b7d-8f6f-d572f1db9ac0
eqs = [
	D(x) ~ x_t
	D(x_t) ~ (u - m * l * theta_t^2 * sin(theta) + m * g * sin(theta) * cos(theta)) / (M + m * (1 - cos(theta)^2))
	D(theta) ~ theta_t
	D(theta_t) ~ (u * cos(theta) + (M + m) * g * sin(theta) - m * l * theta_t^2 * sin(theta) * cos(theta)) / ((M + m) * l - m * l * cos(theta)^2)
]

# ╔═╡ 128431bb-b7ee-4850-acdf-be44cb9221f0
@named sys = ODESystem(eqs, t)

# ╔═╡ 81a9fdbe-88eb-43dd-8e42-8313f7cb5d87
matrices, simplified_sys = linearize(sys, [u], [x, theta])

# ╔═╡ ef3b388c-deea-48e1-afc9-ab6b7213200a
matrices

# ╔═╡ 19485e01-d0b7-44bc-8e7b-b7058b40fc00
begin
	Q = Diagonal([1, 0.1, 15, 0.1])
	R = 0.01
	sy = c2d(ss(matrices...), 0.02)
	L1 = lqr(Discrete, sy.A, sy.B, Q, R)
end
...
[compat]
ControlSystems = "~1.7.3"
ModelingToolkit = "~8.56.0"
Plots = "~1.38.13"
"""
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "3bd45a15dc1a56ad2df479fac3ddfb7874400806"
...
git-tree-sha1 = "452aada15b5b38f1f327990c34a088517359dabe"
...
git-tree-sha1 = "3d037c7d09f5d23fc30ff915105c32f94f16a9ea"
...
git-tree-sha1 = "424db79050ae35888128020512188273f0600dd4"
...
git-tree-sha1 = "8c4e30ff45954b40d5deaaf967862c288dfd023c"
...
git-tree-sha1 = "00c1a289ddeb9ffe42cc081ea568d110dd505b19"
...
git-tree-sha1 = "689bb234631da215f8cb844356f53f17fea84152"
